...
# ── Fast intra-chunk kernel (B200 CUTE-DSL > Triton > PyTorch fallback) ──────
# Imported lazily so qwen3_5_transformers.py works even without the kernel file.
try:
    from qwen3_5_cutedsl_kernels import fast_chunk_gated_delta_rule as _fast_kernel
    chunk_gated_delta_rule = _fast_kernel
    is_fast_path_available = True
except Exception:
    chunk_gated_delta_rule = None   # falls back to torch_chunk_gated_delta_rule below
